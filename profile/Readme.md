...
* **[Datahall](https://github.com/bluewave-labs/datahall)**: *(development ongoing)* A secure space where confidential documents can be kept and only read by people authorized to access them. 
